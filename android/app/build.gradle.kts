...
val ndkEnv = buildMap {
    file("${project.rootDir}/ndk.env").readLines().forEach { line ->
        if (line.contains("=")) {
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.neocare.clinic"
        minSdk = 28
        targetSdk = 36
        compileSdk = 36
        ...
        productFlavors {
            ...
            register("versionDev") {
                applicationId = "com.neocare.clinic.beta"
                dimension = "default"
            ...
            register("qa") {
                applicationId = "com.neocare.clinic.qa"
                dimension = "default"
                versionCode = 1
                versionName = "1"
            }
