    ...
    : QObject(nullptr)
{
    ...
    reserveDarkPalette.setColor(QPalette::Highlight, QColor(124, 58, 61));
    reserveDarkPalette.setColor(QPalette::HighlightedText, Qt::white);
    reserveDarkPalette.setColor(QPalette::Link, QColor(203, 171, 88));
    reserveDarkPalette.setColor(QPalette::LinkVisited, QColor(145, 73, 35));
    ...
    reserveDarkPalette.setColor(QPalette::Accent, QColor(124, 58, 61));
