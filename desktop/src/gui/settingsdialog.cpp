...
constexpr auto TOOLBAR_CSS = QLatin1String(
    ...
    "QToolBar QToolButton { background: transparent; border: none; margin: 0; padding: 8px 12px; font-size: 14px; border-radius: 8px; color: palette(window-text); } "
    "QToolBar QToolBarExtension { padding: 0; } "
    "QToolBar QToolButton:checked { background: #7c3a3d; color: #ffffff; }"
    "QToolBar QToolButton:hover:!checked { background: rgba(124, 58, 61, 0.2); border-radius: 8px; }"
);
